...
public class ChainedTransactionManager implements PlatformTransactionManager {
	...
	ChainedTransactionManager(SynchronizationManager synchronizationManager,
		...
		if(transactionManagers.length == 0) {
			this.transactionManagers = new ArrayList<>();
			this.transactionManagers.add(new PlatformTransactionManager() {
				@Override
	...
	public void init(Collection<PlatformTransactionManager> transactionManagers) {
		this.transactionManagers = new ArrayList<PlatformTransactionManager>(transactionManagers);
	}
}
