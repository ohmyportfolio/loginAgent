<template>
  <div class="responsive-paddings">
    <oc-data-grid title="계정 사용 현황 관리" resource="occupieds" :has-form="false" :show-refresh="true" 
      ...
      <dx-editing :allow-adding="false" :allow-updating="false" :allow-deleting="true" mode="batch"/>
    </oc-data-grid>
  </div>
</template>